...
\begin{frame}
  \Wider[6em]{
    \includegraphics<+>[width=\textwidth]{win-162309}
    \includegraphics<+>[width=\textwidth]{win-162509}
    \includegraphics<+>[width=\textwidth]{win-162511}
    \includegraphics<+>[width=\textwidth]{win-165006}
    \includegraphics<+>[width=\textwidth]{win-165827}
    \includegraphics<+>[width=\textwidth]{win-165830}
    \includegraphics<+>[width=\textwidth]{win-165832}
    \includegraphics<+>[width=\textwidth]{win-165834}
    \includegraphics<+>[width=\textwidth]{win-165838}
  }
\end{frame}
